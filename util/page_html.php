<?php
	...
	if ($request_page_pre > 0 && $request_page_next <= $pageCount) { // pre,next
	    $page_html .= "<a id='pre' class='pre_next' href='javascript:page($request_page_pre)'><em></em>pre</a>";
		$page_html .= "<a id='next' class='pre_next' href='javascript:page($request_page_next)'><em></em>next</a>";
